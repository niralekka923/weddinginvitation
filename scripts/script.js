...
// URL Parameter method + Timer (CountDown System)
document.addEventListener("DOMContentLoaded", function() {
    const urlParams = new URLSearchParams(window.location.search);
    const v = urlParams.get('v');

    // आपका सिक्रेट मास्टर पासवर्ड यहाँ सेट करें
    ...
    if (v) {
        try {
            ...
            // अगर फॉर्म से आया पासवर्ड मास्टर पासवर्ड से मैच करता है, तो वाटरमार्क हटा दें
            if (data.cardPassword && data.cardPassword === MASTER_PASSWORD) {
                const watermark = document.getElementById('watermarkOverlay');
                if (watermark) {
                    watermark.style.display = 'none'; // वाटरमार्क गायब
                }
            }
            // -------------------------------

            // 1. Class के आधार पर डेटा और इमेज अपडेट करना
